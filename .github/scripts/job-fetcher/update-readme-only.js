 ...
 *
 * Repo filter config: { domains: ['data_science'], employment: 'entry_level', locations: ['us'] }
 */
...
const REPO_FILTERS = { domains: ['data_science'], employment: 'entry_level', locations: ['us'] };
